...
[Servers To Check]
Target01 = http://10.0.0.10/
Target02 = http://10.0.0.11/
Target03 = http://10.0.0.12/
Target04 = http://10.0.0.13/
Target05 = http://10.0.0.14/
Target06 = http://10.0.0.14/mutillidae/
Target07 = http://10.0.0.14/twiki/
Target08 = http://10.0.0.15/
Target09 = http://10.0.0.15/mutillidae/
Target10 = http://10.0.0.15/twiki/
______________________________________________________________
...
def getsettings():
        ...
        configfile = config.read("/etc/netkothconfig.ini")
...
def checkpagesandscore():
        scoresfile = scores.read("/var/log/netkothscores.txt")
        ...
        with open("/var/log/netkothscores.txt", 'wb') as scoresfile:
...
def maketables(server):
        ...
        try:
            ...
            tableresults = tableresults + "<a href=\"" + server[1] + "\">" + server[0] +"</a>"
...
while 1:
        ...
        templatefilehandle = open("/etc/template.htm", 'r')
        ...
        for server in serverstocheck:
            ...
            print "Searching for " + serverlabeltag + " tag to replace in /etc/template.htm (case sensitive)"
